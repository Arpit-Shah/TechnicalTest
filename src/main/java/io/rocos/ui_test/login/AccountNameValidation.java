...
@TestCase(sequence = 4)
public class AccountNameValidation implements TestExecutable {

	@Unit(sequence = 1, dataprovider = "ACCOUNT_NAME_COMBINATIONS")
	public void testUnit_1(TestContext context) throws Exception {
		...
		String accountName = (String) context.getParameterisedObject1();
		String expectedError = (String) context.getParameterisedObject2();
		context.getLogger().info("AccountName : " + accountName + ", Expected Error : " + expectedError);
		pSignUp.fillAccountName(accountName);
		context.setTestStatus(TestStatus.PASS,
	...
	@DataProvider(name = "ACCOUNT_NAME_COMBINATIONS")
	public Object[][] dataproviderMethod_1(TestContext context) {

		// @formatter:off
		Object[][] data = new Object[][]
			{
				{"", PageSignUp.DE_AccountName}, 					// Empty Input
				
				{" ", PageSignUp.VE_AccountName},					// Input starting with Space
